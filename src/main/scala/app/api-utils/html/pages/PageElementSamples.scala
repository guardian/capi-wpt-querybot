 ...
 */
  ...
  def returnPageSamplesAsHTMLRows(): String = {
    ...
    val row4 =  "<tr>" + "<td>" +"documentCloud: " + "</td>" + "<td>"  + returnPageSample(4) + "</td>" + "</tr>" + "\n"
    val row5 =  "<tr>" + "<td>" +"facebook: " + "</td>" + "<td>"  + returnPageSample(5) + "</td>" + "</tr>" + "\n"
    val row6 =  "<tr>" + "<td>" +"formStack: " + "</td>" + "<td>"  + returnPageSample(6) + "</td>" + "</tr>" + "\n"
    val row7 =  "<tr>" + "<td>" +"gif: " + "</td>" + "<td>"  + returnPageSample(7) + "</td>" + "</tr>" + "\n"
    val row8 =  "<tr>" + "<td>" +"googleMaps: " + "</td>" + "<td>"  + returnPageSample(8) + "</td>" + "</tr>" + "\n"
    val row9 =  "<tr>" + "<td>" +"guardianAudio: " + "</td>" + "<td>"  + returnPageSample(9) + "</td>" + "</tr>" + "\n"
    val row10 =  "<tr>" + "<td>" +"guardianComments: " + "</td>" + "<td>"  + returnPageSample(10) + "</td>" + "</tr>" + "\n"
    val row11 =  "<tr>" + "<td>" +"guardianVideo: " + "</td>" + "<td>"  + returnPageSample(11) + "</td>" + "</tr>" + "\n"
    val row12 =  "<tr>" + "<td>" +"guardianImages: " + "</td>" + "<td>"  + returnPageSample(12) + "</td>" + "</tr>" + "\n"
    val row13 =  "<tr>" + "<td>" +"guardianUpload: " + "</td>" + "<td>"  + returnPageSample(13) + "</td>" + "</tr>" + "\n"
    val row14 =  "<tr>" + "<td>" +"guardianWitnessImage: " + "</td>" + "<td>"  + returnPageSample(14) + "</td>" + "</tr>" + "\n"
    val row15 =  "<tr>" + "<td>" +"guardianWitnessVideo: " + "</td>" + "<td>"  + returnPageSample(15) + "</td>" + "</tr>" + "\n"
    val row16 =  "<tr>" + "<td>" +"hulu: " + "</td>" + "<td>"  + returnPageSample(16) + "</td>" + "</tr>" + "\n"
    val row17 =  "<tr>" + "<td>" +"image: " + "</td>" + "<td>"  + returnPageSample(17) + "</td>" + "</tr>" + "\n"
