 ...
 */
  ...
  def returnPageSamplesAsHTMLRows(): String = {
    ...
    val row3 =  "<tr>" + "<td>" +  "commercial (paid content): " + "</td>" + "<td>"  + returnPageSample(3) + "</td>" + "</tr>" + "\n"
    val row4 =  "<tr>" + "<td>" +  "dailymotion: " + "</td>" + "<td>"  + returnPageSample(4) + "</td>" + "</tr>" + "\n"
    ...
    val row9 =  "<tr>" + "<td>" +"googleMaps: " + "</td>" + "<td>"  + returnPageSample(9) + "</td>" + "</tr>" + "\n"
    val row10 =  "<tr>" + "<td>" +"guardianAudio: " + "</td>" + "<td>"  + returnPageSample(10) + "</td>" + "</tr>" + "\n"
    val row11 =  "<tr>" + "<td>" +"guardianComments: " + "</td>" + "<td>"  + returnPageSample(11) + "</td>" + "</tr>" + "\n"
    val row12 =  "<tr>" + "<td>" +"guardianVideo: " + "</td>" + "<td>"  + returnPageSample(12) + "</td>" + "</tr>" + "\n"
    val row13 =  "<tr>" + "<td>" +"guardianImages: " + "</td>" + "<td>"  + returnPageSample(13) + "</td>" + "</tr>" + "\n"
    val row14 =  "<tr>" + "<td>" +"guardianUpload: " + "</td>" + "<td>"  + returnPageSample(14) + "</td>" + "</tr>" + "\n"
    val row15 =  "<tr>" + "<td>" +"guardianWitnessImage: " + "</td>" + "<td>"  + returnPageSample(15) + "</td>" + "</tr>" + "\n"
    val row16 =  "<tr>" + "<td>" +"guardianWitnessVideo: " + "</td>" + "<td>"  + returnPageSample(16) + "</td>" + "</tr>" + "\n"
    val row17 =  "<tr>" + "<td>" +"hulu: " + "</td>" + "<td>"  + returnPageSample(17) + "</td>" + "</tr>" + "\n"
    val row18 =  "<tr>" + "<td>" +"image: " + "</td>" + "<td>"  + returnPageSample(18) + "</td>" + "</tr>" + "\n"
    val row19 =  "<tr>" + "<td>" +"infoStrada: " + "</td>" + "<td>"  + returnPageSample(19) + "</td>" + "</tr>" + "\n"
    val row20 =  "<tr>" + "<td>" +"instagram: " + "</td>" + "<td>"  + returnPageSample(20) + "</td>" + "</tr>" + "\n"
    val row21 =  "<tr>" + "<td>" +"interactive: " + "</td>" + "<td>"  + returnPageSample(21) + "</td>" + "</tr>" + "\n"
    val row22 =  "<tr>" + "<td>" +"m3u8 (ios specific video format): " + "</td>" + "<td>"  + returnPageSample(22) + "</td>" + "</tr>" + "\n"
    val row23 =  "<tr>" + "<td>" +"mp3 audio: " + "</td>" + "<td>"  + returnPageSample(23) + "</td>" + "</tr>" + "\n"
    val row24 =  "<tr>" + "<td>" +"mp4 video: " + "</td>" + "<td>"  + returnPageSample(24) + "</td>" + "</tr>" + "\n"
    val row25 =  "<tr>" + "<td>" +"parliamentLiveTv: " + "</td>" + "<td>"  + returnPageSample(25) + "</td>" + "</tr>" + "\n"
    val row26 =  "<tr>" + "<td>" +"scribd: " + "</td>" + "<td>"  + returnPageSample(26) + "</td>" + "</tr>" + "\n"
    val row27 =  "<tr>" + "<td>" +"soundCloud: " + "</td>" + "<td>"  + returnPageSample(27) + "</td>" + "</tr>" + "\n"
    val row28 =  "<tr>" + "<td>" +"spotify: " + "</td>" + "<td>"  + returnPageSample(28) + "</td>" + "</tr>" + "\n"
    val row29 =  "<tr>" + "<td>" +"twitter: " + "</td>" + "<td>"  + returnPageSample(29) + "</td>" + "</tr>" + "\n"
    val row30 =  "<tr>" + "<td>" +"uStream: " + "</td>" + "<td>"  + returnPageSample(30) + "</td>" + "</tr>" + "\n"
    val row31 =  "<tr>" + "<td>" +"vevo: " + "</td>" + "<td>"  + returnPageSample(31) + "</td>" + "</tr>" + "\n"
    val row32 =  "<tr>" + "<td>" +"video format 3gp: " + "</td>" + "<td>"  + returnPageSample(32) + "</td>" + "</tr>" + "\n"
    val row33 =  "<tr>" + "<td>" +"vimeo: " + "</td>" + "<td>"  + returnPageSample(33) + "</td>" + "</tr>" + "\n"
    val row34 =  "<tr>" + "<td>" +"vine: " + "</td>" + "<td>"  + returnPageSample(34) + "</td>" + "</tr>" + "\n"
    val row35 =  "<tr>" + "<td>" +"webp video: " + "</td>" + "<td>"  + returnPageSample(35) + "</td>" + "</tr>" + "\n"
    val row36 =  "<tr>" + "<td>" +"youTube video: " + "</td>" + "<td>"  + returnPageSample(36) + "</td>" + "</tr>" + "\n"
    val row37 =  "<tr>" + "<td>" +"unknownEmbed: " + "</td>" + "<td>"  + returnPageSample(37) + "</td>" + "</tr>" + "\n"
