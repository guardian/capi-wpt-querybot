...
*/
  ...
  val pagesWithCommercialEmbed = allResults.filter(pageContainsElementType(_, "commercial"))
  ...
  val commercial: List[PageElementFromHTMLTableRow] = mapOfElementsByType.getOrElse("commercial", List())
  ...
  val commercialSummary = summariseElement("commercial", pagesWithCommercialEmbed, commercial)
  ...
  def getSamplePageArray: Array[Option[PerformanceResultsObject]] = {
    ...
    val commercial = getPage(pagesWithCommercialEmbed)
