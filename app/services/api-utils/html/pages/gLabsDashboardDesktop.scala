...
import _root_.services.apiutils.PerformanceResultsObject
 ...
 */
class GLabsDashboardDesktop(combinedResultsList: List[PerformanceResultsObject], desktopResultsList: List[PerformanceResultsObject], mobileResultsList: List[PerformanceResultsObject]) {

  //HTML Page elements
  //Page Header
  val HTML_PAGE_HEAD: String = "<!DOCTYPE html><html lang=\"en\">" + "\n" +
    "<head> <meta http-equiv=\"content-type\" content=\"text/html; charset=utf-8\"/>" + "\n" +
    "<title>Paid-content Performance Dashboard - [Paid-content Performance Dashboard]</title>" + "\n" +
  ...
  val HTML_PAGE_CONTAINER: String = "<body>" + "\n" +
    "<div id=\"container\">" + "\n" +
    "<div id=\"head\">" + "\n" +
    "<h1>Current performance of today's paid content</h1>" + "\n" +
  ...
  def getAlertClass(resultsObject: PerformanceResultsObject): String = {
    if (resultsObject.alertStatusPageSpeed || resultsObject.alertStatusPageWeight) {
      "alert"
    } else {
      "default"
    }
